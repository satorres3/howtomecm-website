...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const homepageContent = homepageResult.success ? (homepageResult.data as HomepageContent | null) : null

  if (homepageContent?.seo) {
    return {
      title: homepageContent.seo.pageTitle,
      description: homepageContent.seo.metaDescription
    }
  }
...
export default async function HomePage() {
  ...
  const heroHeading = homepageContent?.welcome?.mainHeading?.trim() ||
