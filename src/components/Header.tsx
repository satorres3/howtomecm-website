...
export default function Header() {
  ...
  if (!settings) {
    return (
      <header className="fixed left-0 right-0 top-0 z-50">
        <nav className="border-b border-white/20 bg-white/80 backdrop-blur-md dark:border-gray-700/30 dark:bg-gray-900/80">
  ...
  const headerNavigation = (
    navigation?.primary?.length ? navigation.primary : fallbackNavigation
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center space-x-8 md:flex">
              ...
              {headerNavigation.map((item: any) => (
                <Link
                  ...
                  className="group relative font-medium text-gray-700 transition-all duration-200 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400"
                >
                  {item.label}
                ...
                <div className="flex items-center space-x-2">
                  {socialLinks.map((social: any) => (
                    <a
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-600/90 text-white backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:bg-gray-600"
              ...
              {showSearch && (
                <div className="relative">
                  <div
                    className={`transition-all duration-300 ${isSearchFocused ? 'w-80' : 'w-64'}`}
                  >
                    <input
                      type="text"
                      placeholder="Search articles..."
                      className="w-full rounded-xl border border-gray-300/50 bg-white/70 py-2.5 pl-10 pr-4 text-gray-900 placeholder-gray-500 backdrop-blur-sm transition-all duration-300 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/50 dark:border-gray-600/50 dark:bg-gray-800/70 dark:text-gray-100 dark:placeholder-gray-400 dark:focus:border-blue-400/50"
            ...
            <div className="md:hidden">
              <button
                ...
                className="rounded-md p-1 text-gray-700 transition-colors hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:text-gray-300 dark:hover:text-blue-400"
            ...
            <div className="space-y-2">
              {headerNavigation.map((item: any) => (
                <Link
                  ...
                  href={item.href || item.url || '#'}
                  target={item.target || '_self'}
                  className="block px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 focus:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 dark:text-gray-300 dark:hover:bg-gray-800 dark:focus:bg-gray-800"
                ...
                <div className="flex items-center justify-center space-x-4">
                  {socialLinks.map((social: any) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex h-12 w-12 items-center justify-center rounded-lg text-white transition-colors"
                      title={social.label || social.platform}
                      style={{
                        backgroundColor: getSocialColor(social.platform),
                      }}
