          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              <a
                ...
                className="w-10 h-10 bg-red-600 hover:bg-red-700 text-white rounded-lg flex items-center justify-center transition-colors group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#0077B5] hover:bg-[#005885] text-white rounded-lg flex items-center justify-center transition-colors group"
